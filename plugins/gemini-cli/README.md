...
A Claude Code plugin that enables effective orchestration of Google's Gemini CLI as an auxiliary AI tool.
...
⚠️ **Important:** Claude Code will NOT configure authentication. You must complete the one-time setup manually before using this skill. See the skill's `references/commands.md` for detailed setup instructions.
