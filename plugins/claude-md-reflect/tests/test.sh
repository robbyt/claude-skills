...
if [ -f "$SKILL_DIR/references/anthropic-best-practices.md" ]; then
    echo -e "    ${GREEN}✓${NC} anthropic-best-practices.md exists"
else
    echo -e "    ${RED}✗${NC} anthropic-best-practices.md missing"
    exit 1
fi

if [ -f "$SKILL_DIR/references/anti-patterns.md" ]; then
    echo -e "    ${GREEN}✓${NC} anti-patterns.md exists"
else
    echo -e "    ${RED}✗${NC} anti-patterns.md missing"
    exit 1
fi
